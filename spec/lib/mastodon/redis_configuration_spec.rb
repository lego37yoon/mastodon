...
RSpec.describe Mastodon::RedisConfiguration do
  let(:empty_redis_environment) do
    %w(
      REDIS_URL REDIS_HOST REDIS_PORT REDIS_DB REDIS_USERNAME REDIS_PASSWORD
      REDIS_SENTINELS REDIS_SENTINEL_MASTER REDIS_SENTINEL_PORT REDIS_SENTINEL_USERNAME REDIS_SENTINEL_PASSWORD
      CACHE_REDIS_URL CACHE_REDIS_HOST CACHE_REDIS_PORT CACHE_REDIS_DB CACHE_REDIS_USERNAME CACHE_REDIS_PASSWORD
      CACHE_REDIS_SENTINELS CACHE_REDIS_SENTINEL_MASTER CACHE_REDIS_SENTINEL_PORT CACHE_REDIS_SENTINEL_USERNAME CACHE_REDIS_SENTINEL_PASSWORD
      SIDEKIQ_REDIS_URL SIDEKIQ_REDIS_HOST SIDEKIQ_REDIS_PORT SIDEKIQ_REDIS_DB SIDEKIQ_REDIS_USERNAME SIDEKIQ_REDIS_PASSWORD
      SIDEKIQ_REDIS_SENTINELS SIDEKIQ_REDIS_SENTINEL_MASTER SIDEKIQ_REDIS_SENTINEL_PORT SIDEKIQ_REDIS_SENTINEL_USERNAME SIDEKIQ_REDIS_SENTINEL_PASSWORD
    ).index_with { nil }
  end
  ...
  around do |example|
    ClimateControl.modify(**empty_redis_environment) { example.run }
  end
