...
class StatusReactionValidator < ActiveModel::Validator
  ...
  def validate(reaction)
    ...
    reaction.errors.add(:name, I18n.t('reactions.errors.unrecognized_emoji')) if reaction.account.local? && reaction.custom_emoji.present? && reaction.custom_emoji.domain.present?
